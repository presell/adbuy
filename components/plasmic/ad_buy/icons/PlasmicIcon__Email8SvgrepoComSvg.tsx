...
export type Email8SvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Email8SvgrepoComSvgIcon(props: Email8SvgrepoComSvgIconProps) {
...
export default Email8SvgrepoComSvgIcon;
/* prettier-ignore-end */
