...
export type BankofamericaSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function BankofamericaSvgIcon(props: BankofamericaSvgIconProps) {
...
export default BankofamericaSvgIcon;
/* prettier-ignore-end */
