...
import sty from "./PlasmicPricing.module.css"; // plasmic-import: S7xqxCh9UkC-/css
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__fH8Hv)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg___6YvEb)}
                    role={"img"}
                  />
                ...
                >
                  {
                    "No retainers, no setup fees, no hidden costs. You set a daily budget, and we deliver exclusive, real-time leads."
                  }
                </div>
                <PlasmicLink__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__ufqDh, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox___9FwPt,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg___7Aol6)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__klk3C)}
                role={"img"}
              />
...
export const PlasmicPricing = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    pageMetadata: {
      title: "Pricing | AdBuy",
      description:
        "AdBuy Campaigns produces exclusive real-time leads with zero learning curve—just choose your industry, product, budget, and location.",
      ogImageSrc:
