...
import sty from "./PlasmicCompareAgency.module.css"; // plasmic-import: 99p42zKvFBCc/css
...
export type PlasmicCompareAgency__VariantMembers = {};
export type PlasmicCompareAgency__VariantsArgs = {};
type VariantPropType = keyof PlasmicCompareAgency__VariantsArgs;
export const PlasmicCompareAgency__VariantProps = new Array<VariantPropType>();

export type PlasmicCompareAgency__ArgsType = {};
type ArgPropType = keyof PlasmicCompareAgency__ArgsType;
export const PlasmicCompareAgency__ArgProps = new Array<ArgPropType>();

export type PlasmicCompareAgency__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultCompareAgencyProps {}
...
function PlasmicCompareAgency__RenderFunc(props: {
  variants: PlasmicCompareAgency__VariantsArgs;
  args: PlasmicCompareAgency__ArgsType;
  overrides: PlasmicCompareAgency__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicCompareAgency.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicCompareAgency.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicCompareAgency.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicCompareAgency.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__hs1Zg)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__yrprI)}
                    role={"img"}
                  />
                ...
                >
                  {
                    "Agencies charge thousands before you see a single lead. AdBuy replaces that with a simple self-serve model that allows you to launch in seconds, pay only for ad spend, and get the power of a full agency\u2014without the overhead."
                  }
                </div>
                <PlasmicLink__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__uwNc, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__anM8J,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__bj0Az)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__noUt8)}
                role={"img"}
              />
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCompareAgency__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicCompareAgency__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicCompareAgency__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCompareAgency__ArgProps,
          internalVariantPropNames: PlasmicCompareAgency__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCompareAgency__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCompareAgency";
  } else {
    func.displayName = `PlasmicCompareAgency.${nodeName}`;
  }
  return func;
}

export const PlasmicCompareAgency = Object.assign(
  // Top-level PlasmicCompareAgency renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCompareAgency
    internalVariantProps: PlasmicCompareAgency__VariantProps,
    internalArgProps: PlasmicCompareAgency__ArgProps,

    // Page metadata
    pageMetadata: {
      title: "Marketing Agencies vs. AdBuy | The #1 Agency Alternative | AdBuy",
      description:
        "AdBuy is the #1 Ad Agency alternative for real-time, high-intent, OTP-verified Insurance, Mortgage, Medical, Legal, and Home Service leads.",
      ogImageSrc:
...
export default PlasmicCompareAgency;
/* prettier-ignore-end */
