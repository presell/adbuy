...
import sty from "./PlasmicCampaigns.module.css"; // plasmic-import: FDpmuApHNq5P/css
...
export type PlasmicCampaigns__VariantMembers = {};
export type PlasmicCampaigns__VariantsArgs = {};
type VariantPropType = keyof PlasmicCampaigns__VariantsArgs;
export const PlasmicCampaigns__VariantProps = new Array<VariantPropType>();

export type PlasmicCampaigns__ArgsType = {};
type ArgPropType = keyof PlasmicCampaigns__ArgsType;
export const PlasmicCampaigns__ArgProps = new Array<ArgPropType>();

export type PlasmicCampaigns__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultCampaignsProps {}
...
function PlasmicCampaigns__RenderFunc(props: {
  variants: PlasmicCampaigns__VariantsArgs;
  args: PlasmicCampaigns__ArgsType;
  overrides: PlasmicCampaigns__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicCampaigns.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicCampaigns.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicCampaigns.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicCampaigns.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__uuq3Z)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__k6Ikb)}
                    role={"img"}
                  />
                ...
                >
                  {
                    "Set up a campaign in minutes with zero learning curve\u2014just choose your industry, product, budget, and location."
                  }
                </div>
                <PlasmicLink__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__shfEr, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__bhI04,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__leu4F)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__vcgHa)}
                role={"img"}
              />
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCampaigns__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicCampaigns__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicCampaigns__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCampaigns__ArgProps,
          internalVariantPropNames: PlasmicCampaigns__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCampaigns__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCampaigns";
  } else {
    func.displayName = `PlasmicCampaigns.${nodeName}`;
  }
  return func;
}

export const PlasmicCampaigns = Object.assign(
  // Top-level PlasmicCampaigns renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCampaigns
    internalVariantProps: PlasmicCampaigns__VariantProps,
    internalArgProps: PlasmicCampaigns__ArgProps,

    // Page metadata
    pageMetadata: {
      title: "AdBuy Campaigns",
      description:
        "Set up campaigns in minutes with zero learning curve—just choose your industry, product, budget, and location to start generating exclusive real-time leads.",
      ogImageSrc:
...
export default PlasmicCampaigns;
/* prettier-ignore-end */
