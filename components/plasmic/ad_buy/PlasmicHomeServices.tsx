...
import sty from "./PlasmicHomeServices.module.css"; // plasmic-import: 7ZF5tsQkPTrk/css
...
export type PlasmicHomeServices__VariantMembers = {};
export type PlasmicHomeServices__VariantsArgs = {};
type VariantPropType = keyof PlasmicHomeServices__VariantsArgs;
export const PlasmicHomeServices__VariantProps = new Array<VariantPropType>();

export type PlasmicHomeServices__ArgsType = {};
type ArgPropType = keyof PlasmicHomeServices__ArgsType;
export const PlasmicHomeServices__ArgProps = new Array<ArgPropType>();

export type PlasmicHomeServices__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultHomeServicesProps {}
...
function PlasmicHomeServices__RenderFunc(props: {
  variants: PlasmicHomeServices__VariantsArgs;
  args: PlasmicHomeServices__ArgsType;
  overrides: PlasmicHomeServices__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicHomeServices.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicHomeServices.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicHomeServices.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicHomeServices.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__xn9HK)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__hfA25)}
                    role={"img"}
                  />
            ...
            <div className={classNames(projectcss.all, sty.freeBox__cRf1, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__matzX,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__a9Az4)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__cNbta)}
                role={"img"}
              />
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicHomeServices__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicHomeServices__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicHomeServices__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicHomeServices__ArgProps,
          internalVariantPropNames: PlasmicHomeServices__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicHomeServices__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicHomeServices";
  } else {
    func.displayName = `PlasmicHomeServices.${nodeName}`;
  }
  return func;
}

export const PlasmicHomeServices = Object.assign(
  // Top-level PlasmicHomeServices renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicHomeServices
    internalVariantProps: PlasmicHomeServices__VariantProps,
    internalArgProps: PlasmicHomeServices__ArgProps,

    // Page metadata
    pageMetadata: {
      title: "Exclusive Real-Time OTP-Verified Home Service Leads | AdBuy",
      description:
        "Home Service Campaigns generate more booked jobs by putting qualified leads directly on your calendar—no chasing calls or manual follow-up.",
      ogImageSrc:
...
export default PlasmicHomeServices;
/* prettier-ignore-end */
