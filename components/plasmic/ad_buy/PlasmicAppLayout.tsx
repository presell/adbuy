  ...
  return (
    ...
    >
      ...
      <Embed
        ...
        code={
          '<script>\n(function waitForGrab() {\n  const grab = document.querySelector(".grab");\n  if (!grab) {\n    setTimeout(waitForGrab, 300);\n    return;\n  }\n\n  const sheet = grab.closest(".create-container");\n  if (!sheet) {\n    console.warn("No .create-container found");\n    return;\n  }\n\n  console.log("Grab + sheet ready \u2705");\n\n  let startY = 0;\n  let currentY = 0;\n  let isDragging = false;\n\n  grab.addEventListener("touchstart", (e) => {\n    startY = e.touches[0].clientY;\n    isDragging = true;\n    sheet.style.transition = "none";\n    console.log("touchstart");\n  }, { passive: false });\n\n  grab.addEventListener("touchmove", (e) => {\n    if (!isDragging) return;\n    currentY = e.touches[0].clientY;\n    const deltaY = currentY - startY;\n\n    if (deltaY > 0) {\n      e.preventDefault(); // stop scroll\n      sheet.style.transform = `translateY(${deltaY}px)`; // follow finger\n    }\n  }, { passive: false });\n\n  grab.addEventListener("touchend", (e) => {\n    if (!isDragging) return;\n    isDragging = false;\n    const endY = e.changedTouches[0].clientY;\n    const deltaY = endY - startY;\n    console.log("touchend, deltaY:", deltaY);\n\n    // threshold ~80px\n    if (deltaY > 80) {\n      sheet.style.transition = "transform 0.25s ease";\n      sheet.style.transform = "translateY(100%)";\n      console.log("swipe down detected \u2705");\n      setTimeout(() => {\n        if (window.$plasmic?.updateStateValue) {\n          console.log("closing via $plasmic.updateStateValue");\n          window.$plasmic.updateStateValue({\n            path: ["popOpen"],\n            value: false\n          });\n        } else {\n          console.warn("window.$plasmic missing, hiding manually");\n          sheet.style.display = "none";\n        }\n      }, 250);\n    } else {\n      // snap back if too short\n      sheet.style.transition = "transform 0.25s ease";\n      sheet.style.transform = "translateY(0)";\n    }\n  }, { passive: false });\n})();\n</script>\n\n\n<style>\nhtml, body {\n  overscroll-behavior: none; /* disables Safari/iOS pull-to-refresh */\n}\n\n.grab {\n  touch-action: none; /* lets your JS handle touch gestures instead of scroll */\n}\n</style>'
        }
      />
    </div>
