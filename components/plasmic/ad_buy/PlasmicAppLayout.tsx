  ...
  return (
    ...
    >
      ...
      <Embed
        ...
        code={
          hasVariant(globalVariants, "screen", "mobileOnly")
            ? "<style>\n/* =========================\n   Flicker prevention\n   ========================= */\n\n/* Hide drawer & overlay completely before React hydrates */\nbody.prehydration .drawer,\nbody.prehydration .drawer-overlay {\n  display: none !important;\n}\n\n/* Once hydrated, allow them to render */\nbody.drawer-ready .drawer,\nbody.drawer-ready .drawer-overlay {\n  display: block !important; /* or inline/block as needed; block is safe */\n}\n\n/* =========================\n   Drawer animation (no transform conflicts)\n   ========================= */\n\n/* Base closed state: keep off-canvas using 'left' so we don't collide with any transforms */\n.drawer {\n  /* Do NOT set size/bg/z-index here \u2014 leave those in Plasmic */\n  position: fixed;      /* you already handle positioning in Plasmic; fixed is typical */\n  top: 0;\n  left: calc(var(--drawer-w, 230px) * -1);  /* off-screen by its width */\n  transition: left 0.3s ease-in-out, opacity 0.3s ease-in-out;\n  opacity: 1;           /* keep 1; we slide with 'left' */\n  pointer-events: none; /* block clicks when closed */\n  will-change: left, opacity;\n}\n\n.drawer.open {\n  left: 0;              /* slide in */\n  pointer-events: auto;\n  /* optional shadow; remove if you style in Plasmic */\n  box-shadow: 2px 0 12px rgba(0, 0, 0, 0.15);\n}\n\n/* =========================\n   Overlay fade\n   ========================= */\n.drawer-overlay {\n  /* No size/bg/z-index here if you already set them in Plasmic */\n  opacity: 0;\n  transition: opacity 0.3s ease-in-out;\n  pointer-events: none;\n}\n\n.drawer-overlay.open {\n  opacity: 1;\n  pointer-events: auto;\n}\n\n</style>"
            : ""
        }
      />
    </div>
