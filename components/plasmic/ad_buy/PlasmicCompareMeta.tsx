...
import sty from "./PlasmicCompareMeta.module.css"; // plasmic-import: yajdKF_D85hV/css
...
export type PlasmicCompareMeta__VariantMembers = {};
export type PlasmicCompareMeta__VariantsArgs = {};
type VariantPropType = keyof PlasmicCompareMeta__VariantsArgs;
export const PlasmicCompareMeta__VariantProps = new Array<VariantPropType>();

export type PlasmicCompareMeta__ArgsType = {};
type ArgPropType = keyof PlasmicCompareMeta__ArgsType;
export const PlasmicCompareMeta__ArgProps = new Array<ArgPropType>();

export type PlasmicCompareMeta__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultCompareMetaProps {}
...
function PlasmicCompareMeta__RenderFunc(props: {
  variants: PlasmicCompareMeta__VariantsArgs;
  args: PlasmicCompareMeta__ArgsType;
  overrides: PlasmicCompareMeta__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicCompareMeta.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicCompareMeta.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicCompareMeta.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicCompareMeta.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__rmr1N)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__rwoKa)}
                    role={"img"}
                  />
                ...
                >
                  {"Run Meta Ads Without the Learning Curve."}
                </div>
                <div
                ...
                >
                  {
                    "Forget pages, pixels, audiences, and ad setup. AdBuy automates the entire Meta Ads process\u2014just set your budget and start getting exclusive, inbound leads in real time."
                  }
                </div>
                <PlasmicLink__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__szJf4, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__p32B,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg___6Ssr6)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__ocrno)}
                role={"img"}
              />
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCompareMeta__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicCompareMeta__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicCompareMeta__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCompareMeta__ArgProps,
          internalVariantPropNames: PlasmicCompareMeta__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCompareMeta__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCompareMeta";
  } else {
    func.displayName = `PlasmicCompareMeta.${nodeName}`;
  }
  return func;
}

export const PlasmicCompareMeta = Object.assign(
  // Top-level PlasmicCompareMeta renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCompareMeta
    internalVariantProps: PlasmicCompareMeta__VariantProps,
    internalArgProps: PlasmicCompareMeta__ArgProps,

    // Page metadata
    pageMetadata: {
      title: "Meta Ads vs. AdBuy | The #1 Meta Ads Alternative | AdBuy",
      description:
        "AdBuy is the #1 Meta Ads alternative for real-time, high-intent, OTP-verified Insurance, Mortgage, Medical, Legal, and Home Service leads.",
      ogImageSrc:
...
export default PlasmicCompareMeta;
/* prettier-ignore-end */
