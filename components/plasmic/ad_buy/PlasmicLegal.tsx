...
import sty from "./PlasmicLegal.module.css"; // plasmic-import: zYO_FfxY-_aN/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicLegal.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicLegal.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicLegal.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicLegal.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__dFnVo)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__cBws)}
                    role={"img"}
                  />
                ...
                >
                  {
                    "Generate qualified consults that convert into retained clients without chasing leads."
                  }
                </div>
                <PlasmicLink__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__fIyf, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__cYqc,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__pmbDf)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__tqCz3)}
                role={"img"}
              />
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicLegal__VariantsArgs, ReservedPropsType> &
...
export const PlasmicLegal = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    // Page metadata
    pageMetadata: {
      title: "Exclusive Real-Time OTP-Verified Legal Leads | AdBuy",
      description:
        "Legal Campaigns generate qualified consults that convert into retained clients—helping you sign more high-value cases without chasing leads.",
      ogImageSrc:
