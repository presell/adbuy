...
import sty from "./PlasmicInsurance.module.css"; // plasmic-import: bMPCtW3NjzMH/css
...
export type PlasmicInsurance__VariantMembers = {};
export type PlasmicInsurance__VariantsArgs = {};
type VariantPropType = keyof PlasmicInsurance__VariantsArgs;
export const PlasmicInsurance__VariantProps = new Array<VariantPropType>();

export type PlasmicInsurance__ArgsType = {};
type ArgPropType = keyof PlasmicInsurance__ArgsType;
export const PlasmicInsurance__ArgProps = new Array<ArgPropType>();

export type PlasmicInsurance__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultInsuranceProps {}
...
function PlasmicInsurance__RenderFunc(props: {
  variants: PlasmicInsurance__VariantsArgs;
  args: PlasmicInsurance__ArgsType;
  overrides: PlasmicInsurance__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicInsurance.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicInsurance.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicInsurance.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicInsurance.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__ehO4G)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__ke5Mt)}
                    role={"img"}
                  />
                ...
                >
                  {
                    "Connect with Final Expense, IUL, Annuity, and Medicare prospects the moment they request info."
                  }
                </div>
                <PlasmicLink__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__quQZt, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__d8U1,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__nbE3X)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__ekDcT)}
                role={"img"}
              />
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicInsurance__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicInsurance__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicInsurance__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicInsurance__ArgProps,
          internalVariantPropNames: PlasmicInsurance__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicInsurance__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicInsurance";
  } else {
    func.displayName = `PlasmicInsurance.${nodeName}`;
  }
  return func;
}

export const PlasmicInsurance = Object.assign(
  // Top-level PlasmicInsurance renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicInsurance
    internalVariantProps: PlasmicInsurance__VariantProps,
    internalArgProps: PlasmicInsurance__ArgProps,

    // Page metadata
    pageMetadata: {
      title: "Exclusive Real-Time OTP-Verified Insurance Leads | AdBuy",
      description:
        "Insurance Campaigns connect you with Final Expense, IUL, Annuity, and Medicare prospects in real time—delivering inbound calls and leads ready to talk now.",
      ogImageSrc:
...
export default PlasmicInsurance;
/* prettier-ignore-end */
