...
import sty from "./PlasmicGtm.module.css"; // plasmic-import: c6l1zJVqzUP7/css
...
export type PlasmicGtm__VariantMembers = {};
export type PlasmicGtm__VariantsArgs = {};
type VariantPropType = keyof PlasmicGtm__VariantsArgs;
export const PlasmicGtm__VariantProps = new Array<VariantPropType>();

export type PlasmicGtm__ArgsType = {};
type ArgPropType = keyof PlasmicGtm__ArgsType;
export const PlasmicGtm__ArgProps = new Array<ArgPropType>();

export type PlasmicGtm__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultGtmProps {}
...
function PlasmicGtm__RenderFunc(props: {
  variants: PlasmicGtm__VariantsArgs;
  args: PlasmicGtm__ArgsType;
  overrides: PlasmicGtm__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicGtm.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicGtm.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicGtm.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicGtm.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__sxYAy)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__fsMi5)}
                    role={"img"}
                  />
                ...
                >
                  {"Go-to-Market Engine for Founders"}
                </div>
                <div
                ...
                >
                  {
                    "Done-for-you experiments to test personas, angles, and funnels\u2014so you know what works before scaling or investing in development."
                  }
                </div>
                <PlasmicLink__
            ...
            <div
              className={classNames(projectcss.all, sty.freeBox___5IyHs, ``)}
            >
              <div
                className={classNames(
                  projectcss.all,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__zopfd)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__xbLkt)}
                role={"img"}
              />
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicGtm__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicGtm__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicGtm__ArgProps,
          internalVariantPropNames: PlasmicGtm__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicGtm__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicGtm";
  } else {
    func.displayName = `PlasmicGtm.${nodeName}`;
  }
  return func;
}

export const PlasmicGtm = Object.assign(
  // Top-level PlasmicGtm renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicGtm
    internalVariantProps: PlasmicGtm__VariantProps,
    internalArgProps: PlasmicGtm__ArgProps,

    // Page metadata
    pageMetadata: {
      title: "Meta Ad GTM Motion for SaaS & eCommerce Founders | AdBuy",
      description:
        "Done-for-you enterprise go-to-market consulting. We refine your customer persona, craft an irresistible ad angle, build a funnel and email flow, then launch Meta ads.",
      ogImageSrc:
