...
import sty from "./PlasmicDebt.module.css"; // plasmic-import: WxZMvh90N_L3/css
...
export type PlasmicDebt__VariantMembers = {};
export type PlasmicDebt__VariantsArgs = {};
type VariantPropType = keyof PlasmicDebt__VariantsArgs;
export const PlasmicDebt__VariantProps = new Array<VariantPropType>();

export type PlasmicDebt__ArgsType = {};
type ArgPropType = keyof PlasmicDebt__ArgsType;
export const PlasmicDebt__ArgProps = new Array<ArgPropType>();

export type PlasmicDebt__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultDebtProps {}
...
function PlasmicDebt__RenderFunc(props: {
  variants: PlasmicDebt__VariantsArgs;
  args: PlasmicDebt__ArgsType;
  overrides: PlasmicDebt__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicDebt.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicDebt.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicDebt.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicDebt.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__wgoMf)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__bkrEx)}
                    role={"img"}
                  />
                ...
                >
                  {"Help More People Get Financial Relief"}
                </div>
                <div
                ...
                >
                  {
                    "Generate qualified consults from people actively seeking Credit Repair or Tax Relief."
                  }
                </div>
                <PlasmicLink__
            ...
            <div
              className={classNames(projectcss.all, sty.freeBox___1KRl2, ``)}
            >
              <div
                className={classNames(
                  projectcss.all,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__cnR0R)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__wAjN0)}
                role={"img"}
              />
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicDebt__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicDebt__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicDebt__ArgProps,
          internalVariantPropNames: PlasmicDebt__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicDebt__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicDebt";
  } else {
    func.displayName = `PlasmicDebt.${nodeName}`;
  }
  return func;
}

export const PlasmicDebt = Object.assign(
  // Top-level PlasmicDebt renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicDebt
    internalVariantProps: PlasmicDebt__VariantProps,
    internalArgProps: PlasmicDebt__ArgProps,
