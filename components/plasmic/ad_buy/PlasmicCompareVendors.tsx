...
import sty from "./PlasmicCompareVendors.module.css"; // plasmic-import: 7hcpxa7fUsQr/css
...
export type PlasmicCompareVendors__VariantMembers = {};
export type PlasmicCompareVendors__VariantsArgs = {};
type VariantPropType = keyof PlasmicCompareVendors__VariantsArgs;
export const PlasmicCompareVendors__VariantProps = new Array<VariantPropType>();

export type PlasmicCompareVendors__ArgsType = {};
type ArgPropType = keyof PlasmicCompareVendors__ArgsType;
export const PlasmicCompareVendors__ArgProps = new Array<ArgPropType>();

export type PlasmicCompareVendors__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultCompareVendorsProps {}
...
function PlasmicCompareVendors__RenderFunc(props: {
  variants: PlasmicCompareVendors__VariantsArgs;
  args: PlasmicCompareVendors__ArgsType;
  overrides: PlasmicCompareVendors__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicCompareVendors.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicCompareVendors.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicCompareVendors.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicCompareVendors.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__iUaSk)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__ggOSg)}
                    role={"img"}
                  />
                ...
                >
                  {
                    "Ditch shared lead lists. With AdBuy, every lead is generated for you\u2014and only you. Real-time, inbound, and ready to talk."
                  }
                </div>
                <PlasmicLink__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__ns3Ce, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__xbyxr,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__iiWfd)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__wbLzy)}
                role={"img"}
              />
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCompareVendors__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicCompareVendors__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicCompareVendors__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCompareVendors__ArgProps,
          internalVariantPropNames: PlasmicCompareVendors__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCompareVendors__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCompareVendors";
  } else {
    func.displayName = `PlasmicCompareVendors.${nodeName}`;
  }
  return func;
}

export const PlasmicCompareVendors = Object.assign(
  // Top-level PlasmicCompareVendors renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCompareVendors
    internalVariantProps: PlasmicCompareVendors__VariantProps,
    internalArgProps: PlasmicCompareVendors__ArgProps,

    // Page metadata
    pageMetadata: {
      title: "Lead Vendors vs. AdBuy | The #1 Lead Vendor Alternative | AdBuy",
      description:
        "AdBuy is the #1 Lead Vendor alternative for real-time, high-intent, OTP-verified Insurance, Mortgage, Medical, Legal, and Home Service leads.",
      ogImageSrc:
...
export default PlasmicCompareVendors;
/* prettier-ignore-end */
