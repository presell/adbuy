...
import sty from "./PlasmicDocs.module.css"; // plasmic-import: lqEi2PPEGNsC/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicDocs.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicDocs.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicDocs.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicDocs.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg___4OvUg)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg___9IaSk)}
                    role={"img"}
                  />
                ...
                >
                  {
                    "Master the essentials of AdBuy \u2014 from setting your daily budget to generating real-time, OTP-verified leads."
                  }
                </div>
                <PlasmicLink__
            ...
            <div
              className={classNames(projectcss.all, sty.freeBox___4Mmdp, ``)}
            >
              <div
                className={classNames(
                  projectcss.all,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg___7CFe)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__apHxm)}
                role={"img"}
              />
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicDocs__VariantsArgs, ReservedPropsType> &
...
export const PlasmicDocs = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    pageMetadata: {
      title: "Docs | AdBuy",
      description:
        "AdBuy Docs teaches you how to set budgets, launch campaigns, and generate real-time, OTP-verified Insurance, Mortgage, Medical, Legal, and Home Service leads.",
      ogImageSrc:
