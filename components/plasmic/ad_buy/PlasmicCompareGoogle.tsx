...
import sty from "./PlasmicCompareGoogle.module.css"; // plasmic-import: Ei3dj2clYi8m/css
...
export type PlasmicCompareGoogle__VariantMembers = {};
export type PlasmicCompareGoogle__VariantsArgs = {};
type VariantPropType = keyof PlasmicCompareGoogle__VariantsArgs;
export const PlasmicCompareGoogle__VariantProps = new Array<VariantPropType>();

export type PlasmicCompareGoogle__ArgsType = {};
type ArgPropType = keyof PlasmicCompareGoogle__ArgsType;
export const PlasmicCompareGoogle__ArgProps = new Array<ArgPropType>();

export type PlasmicCompareGoogle__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultCompareGoogleProps {}
...
function PlasmicCompareGoogle__RenderFunc(props: {
  variants: PlasmicCompareGoogle__VariantsArgs;
  args: PlasmicCompareGoogle__ArgsType;
  overrides: PlasmicCompareGoogle__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicCompareGoogle.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicCompareGoogle.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicCompareGoogle.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicCompareGoogle.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__qqLFk)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <LeadsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__lZwvM)}
                    role={"img"}
                  />
                ...
                >
                  {"Run Google Ads Without the Learning Curve."}
                </div>
                <div
                ...
                >
                  {
                    "No keyword groups or ad variations needed. AdBuy automates the entire Google Ads process\u2014just set your budget and start getting exclusive, inbound leads in real time."
                  }
                </div>
                <PlasmicLink__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__tqR9T, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__zpw7H,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__ypmte)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__yFn8K)}
                role={"img"}
              />
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCompareGoogle__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicCompareGoogle__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicCompareGoogle__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCompareGoogle__ArgProps,
          internalVariantPropNames: PlasmicCompareGoogle__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCompareGoogle__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCompareGoogle";
  } else {
    func.displayName = `PlasmicCompareGoogle.${nodeName}`;
  }
  return func;
}

export const PlasmicCompareGoogle = Object.assign(
  // Top-level PlasmicCompareGoogle renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCompareGoogle
    internalVariantProps: PlasmicCompareGoogle__VariantProps,
    internalArgProps: PlasmicCompareGoogle__ArgProps,

    // Page metadata
    pageMetadata: {
      title: "Google Ads vs. AdBuy | The #1 Google Ads Alternative | AdBuy",
      description:
        "AdBuy is the #1 Google Ads alternative for real-time, high-intent, OTP-verified Insurance, Mortgage, Medical, Legal, and Home Service leads.",
      ogImageSrc:
...
export default PlasmicCompareGoogle;
/* prettier-ignore-end */
