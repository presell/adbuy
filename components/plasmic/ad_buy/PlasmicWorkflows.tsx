...
import sty from "./PlasmicWorkflows.module.css"; // plasmic-import: P8w_dzdP8xuY/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicWorkflows.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicWorkflows.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicWorkflows.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicWorkflows.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
            ...
            >
              ...
              {(() => {
                ...
                <LogoutSvgrepoComSvgIcon
                  className={classNames(projectcss.all, sty.svg__h4Zap)}
                  onClick={async event => {
                    const $steps = {};
          ...
          >
              ...
              >
                ...
                >
                  <WorkflowsProductSvgIcon
                    className={classNames(projectcss.all, sty.svg__t2WXk)}
                    role={"img"}
                  />
                ...
                >
                  {
                    "Automated email, SMS, and voice workflows keep every lead moving until they\u2019re ready to convert."
                  }
                </div>
                <PlasmicLink__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__hn1Ua, ``)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox___8IOhq,
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__m1NjL)}
                role={"img"}
              />
              ...
              <CursorIsolatedSvgIcon
                className={classNames(projectcss.all, sty.svg__re6XE)}
                role={"img"}
              />
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicWorkflows__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicWorkflows__ArgsType, ReservedPropsType> &
...
export const PlasmicWorkflows = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    // Page metadata
    pageMetadata: {
      title: "AdBuy Workflows",
      description:
        "AdBuy Workflows automates your follow-up with email, SMS, and voice workflows that run 24/7—keeping every lead engaged until they’re ready to convert.",
      ogImageSrc:
